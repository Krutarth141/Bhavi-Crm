...
export default function UseModal({ engineers, engStock, inventory, onSave, onClose }: Props) {
  ...
  const handleEngineerChange = (eng: string) => {
    setEngineer(eng);
    setPartId(''); // reset part when engineer changes
  };
